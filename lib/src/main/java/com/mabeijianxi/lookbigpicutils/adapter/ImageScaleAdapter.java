...
public class ImageScaleAdapter extends PagerAdapter implements PhotoViewAttacher.OnPhotoTapListener {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        final PicDataBean ealuationPicBean = mPicData.get(position);

        if (ealuationPicBean != null && ealuationPicBean.imageBigUrl != null && !"null".equals(ealuationPicBean.imageBigUrl)) {
