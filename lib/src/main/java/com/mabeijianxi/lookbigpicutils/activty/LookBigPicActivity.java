package com.mabeijianxi.lookbigpicutils.activty;
...
import com.mabeijianxi.lookbigpicutils.adapter.ImageScaleAdapter;
...
import com.mabeijianxi.lookbigpicutils.utils.EvaluateUtil;
import com.mabeijianxi.lookbigpicutils.view.HackyViewPager;
...
public class LookBigPicActivity extends Activity implements View.OnClickListener, ViewTreeObserver.OnPreDrawListener, HackyViewPager.HackyViewPagerDispatchListener {
    ...
    private void getData() {
        ...
        picDataList = (List<PicDataBean>) intent.getSerializableExtra("PICDATALIST");
